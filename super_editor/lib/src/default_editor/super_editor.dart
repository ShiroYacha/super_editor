...
class SuperEditorState extends State<SuperEditor> {
  ...
  late CodeBlockLanguageStyler _codeBlockLanguageStyler;
  ...
  void _createLayoutPresenter() {
    ...
    _codeBlockLanguageStyler =
        CodeBlockLanguageStyler(requestDispatcher: editContext.editor);
...
final defaultKeyboardActions = <DocumentKeyboardAction>[
  ...
  selectAllInCodeBlockWhenCmdAIsPressed,
